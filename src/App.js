            ...
            <main className={styles.main}>
                ...
                <div className={styles.centerblock}>
                    ...
                    >
                        ...
                        <div className={`${styles.filter__button} ${styles.btn_text}`} onClick={() =>  musicFilterClick()}>исполнителю</div>
                         {musicFilter && ( 
                        ...
                        <div className={styles.filter__choice}>
                        <div className={`${styles.filter__button} ${styles.btn_text}`} onClick={() =>  musicYearClick()}>год выпуска</div>
                         {musicYear && ( 
                            <ul className={styles.filter__menu}>
                        ...
                        <div className={styles.filter__choice}>
                        <div className={`${styles.filter__button} ${styles.btn_text}`} onClick={() =>  musicStyleClick()}>жанру</div>
                        {musicStyle && ( 
                            <ul className={styles.filter__menu}>
